		...
		<LandlordLayout>
			...
			<div className="mx-auto max-w-[960px] px-4 py-8 md:px-6 lg:py-12">
				...
				<p className="mt-3 max-w-2xl text-[var(--gtg-muted)]">
					Thông tin càng chính xác, phòng càng dễ tìm được người thuê
					phù hợp và được duyệt nhanh hơn.
				</p>
				{/* <div
				...
				<form className="mt-8 space-y-6" onSubmit={submit}>
						...
						<div className="mb-3 grid gap-3 sm:grid-cols-2">
							{propertyTypes.map((item) => (
								<button
									...
									onClick={() => {
										setType(item.id);
										setData('property_type_id', item.id);
									}}
								...
								>
									...
									<span className="mt-1 block text-sm text-[var(--gtg-muted)]">
										Chọn loại hình phù hợp nhất với phòng
										của bạn.
									</span>
								</button>
							))}
					...
					<Section icon={MapPin} title="Địa chỉ & vị trí phòng trọ">
						...
						<div className="mt-4 rounded-lg border border-[var(--gtg-border)] bg-[var(--gtg-surface-low)] px-4 py-3 text-sm text-[var(--gtg-muted)]">
							Gợi ý chỉ dẫn: đầu hẻm có biển hiệu dễ nhận biết, xe
							máy có thể vào tận cửa.
						</div>
					</Section>
					<Section icon={ReceiptText} title="Giá thuê và tiền cọc">
					...
					>
						<div className="grid gap-4 md:grid-cols-3">
							<Field
								...
								type="text"
								value={data.area_sqm}
								onChange={(value) => setData('area_sqm', value)}
					...
					<Section icon={Sparkles} title="Tiện ích phòng & tòa nhà">
